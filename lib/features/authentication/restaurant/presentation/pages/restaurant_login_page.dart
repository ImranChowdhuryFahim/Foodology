...
class RestaurantLoginPage extends StatelessWidget {
  static route() =>
      MaterialPageRoute(builder: (context) => RestaurantLoginPage());
  ...
  void handleLogin(BuildContext context, UserInfoCubit userCubit) async {
    ...
    try {
      final existingUser = await Supabase.instance.client
          ...
          .eq('document->>usertype', 'restaurant');
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Image.asset('assets/images/restaurant.png', height: 100),
                ...
                GestureDetector(
                  onTap: () => Navigator.push(
                      context, RestaurantRegistrationPage.route()),
                  child: RichText(
                      text: TextSpan(
                          text: 'Not a member? ',
                          style: TextStyle(
